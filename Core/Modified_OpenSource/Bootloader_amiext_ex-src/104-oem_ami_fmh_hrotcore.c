<<<<<<< c7f7d065cc256d03476db603bcd95415a7e39b25
--- uboot/oem/ami/fmh/hrotcore.c	2019-05-07 12:09:03.046199560 +0530
+++ uboot_new/oem/ami/fmh/hrotcore.c	2019-05-07 12:07:49.801787600 +0530
=======
--- uboot_old/oem/ami/fmh/hrotcore.c	2019-03-29 13:12:40.558761682 +0530
+++ uboot_new/oem/ami/fmh/hrotcore.c	2019-03-29 13:26:27.746191480 +0530
>>>>>>> Added support to skip public key section in calculation of secure boot hash
@@ -0,0 +1,173 @@
+# include <common.h>
+# include <config.h>
+# include <command.h>
...
+                        hash_start = startaddress + fmhLocation;
+                        size_to_hash = AllocSize - (2*PROD_SIG_OFFSET);
